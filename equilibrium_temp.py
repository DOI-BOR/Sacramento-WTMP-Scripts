...
def bisection_solve(fTe_min, a, b, H1, uw, Ta_in, td, sat_vp_ta, tol=1e-2, max_iter=1000):
    '''minimization function generated by Chat GPT4'''
...
def dfTe_dTe(Te, H1, uw, Ta_in, Td, sat_vp_ta):
    ...
    dTe_term = - 4 * lw_emissivity_water * stefan_boltz_const * Tk ** 3 - 12 * lw_emissivity_water * stefan_boltz_const * Tk ** 2 * Te
...
def equilibrium_temp(dtt1, at, cl, sr, ws, td, te_guess, type='nr'):
    ...
    if type == 'nr':
        return newton_raphson_solve(fTe, dfTe_dTe, te_guess, H1, ws, at, td, sat_vp_ta, tol=1e-2, max_iter=1000)
    elif type == 'bs':
        return bisection_solve(fTe_min, -30.0, 55.0, H1, ws, at, td, sat_vp_ta, tol=1e-2, max_iter=1000)
    elif type == 'scipy':
...
def calc_equilibrium_temp(dtt, at, cl, sr, td, ws):
    ...
    bisection and newton-raphson solvers partially generated by Chat GPT4
