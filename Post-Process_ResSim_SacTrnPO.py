...
def computeAlternative(currentAlternative, computeOptions):
    ...
    data, and optionally copies additional records into ResSim
    using a shared F-part.
    ...
    Workflow:
      ...
      3. Resolves the F-part associated with the ResSim-linked
         record (ResSim_linked_rec), for use when copying any
         additional records into ResSim.
      ...
      7. Applies the Spring Creek tunnel heating calculation using
         ...
         path.
      8. Copies any additional records in ressim_copy_paths into
         the simulation DSS file, tagged with the ResSim F-part.
    ...
    Returns:
        bool: True once the tunnel heating calculations have been
            applied and any ResSim copy records have been written.
    """
